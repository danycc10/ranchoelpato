...
@can('sistema.ver')
    <x-nav-link href="{{ route('admin.sistema.index') }}" :active="request()->routeIs('admin.sistema.*')">
        Sistema
    </x-nav-link>
@endcan
...
@can('roles.ver')
  <x-responsive-nav-link href="{{ route('admin.roles.index') }}">Roles</x-responsive-nav-link>
@endcan
</div>
