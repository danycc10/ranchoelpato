...
return new class extends Migration {
  ...
  public function down(): void
  {
    Schema::table('contratos', function (Blueprint $table) {
      ...
      if (Schema::hasColumn('contratos', 'tipo')) $table->dropColumn('tipo');
      if (Schema::hasColumn('contratos', 'servicio_tipo')) $table->dropColumn('servicio_tipo');
      if (Schema::hasColumn('contratos', 'es_financiamiento_instalacion')) $table->dropColumn('es_financiamiento_instalacion');
    });
  }
};
